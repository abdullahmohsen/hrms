...
<head>
  ...
  <link rel="stylesheet"
    href="{{ asset('dashboard_files/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="{{ asset('dashboard') }}" class="logo">
        ...
        <span class="logo-mini">hrms</span>
    ...
    @include('layouts.admin.dashboard._aside')
    ...
    <footer class="main-footer">
      ...
      reserved | This Website is made by <a href="https:linkedin.com/in/abdallah-mohsen/">Abdallah Mohsen</a>
    </footer>
