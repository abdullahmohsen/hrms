      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <select name="position_id" class="form-control select2" style="width: 100%;">
              @if ($positions && $positions->count() > 0)
                @foreach ($positions as $position)
                  <option value="{{ $position->id }}" @if ($employee->position_id == $position->id) selected
                @endif >
                {{ $position->title }}
                </option>
              @endforeach
          ...
          <div class="form-group col-md-6">
            ...
            @if (count($employee_supervisors))
              <select class="form-control select2" name="supervisor_employee_id" style="width: 100%;">
                <option value="">Select the employee supervisior</option>
                @foreach ($employee_supervisors as $employee_supervisor)
                  <option value="{{ $employee_supervisor->id }}"
                    {{ $employee->supervisor_employee_id == $employee_supervisor->id ? 'selected' : '' }}>
