          ...
          <form action="{{ route('departments.index') }}" method="get">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <a href="{{ route('departments.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
              </div>
              ...
              <tbody>
                @foreach ($departments as $index => $department)
                  <tr>
                    ...
                    <td><a href="{{ route('positions.index', ['department_id' => $department->id]) }}"
                        class="btn btn-info btn-sm">Related Position</a></td>
                    <td>
                      <a href="{{ route('departments.edit', $department->id) }}" class="btn btn-info btn-sm"><i
